...
The `ebola_sim_contacts` data frame only has 3800 observations, whereas the `ebola_linelist` has 5888 observations. This suggests that we only have information on the source of infection for a subset of the observations. 
